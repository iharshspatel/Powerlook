    ...
    var getViewportMaxWidth = function () {
      ...
      if (slider.settings.slideWidth > 0) {
        if (slider.settings.mode == 'horizontal') {
          // previous version of slider.settings.maxSlides + 2 is slider.settings.maxSlides -1
          width = (slider.settings.maxSlides * slider.settings.slideWidth) + ((slider.settings.maxSlides + 2) * slider.settings.slideMargin);
        } else {
    ...
    var setPositionProperty = function (value, type, duration, params) {
      ...
      if (slider.usingCSS) {
        ...
        if (type == 'slide') {
          ...
          el.animate(animateObj, slider.settings.speed, 'linear', function () {
            setPositionProperty(params['resetValue'], 'reset', 0);

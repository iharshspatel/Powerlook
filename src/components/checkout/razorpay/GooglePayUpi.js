...
class GooglePayUpi extends Component {
  ...
  placeOrder(){
    ...
    this.props.startPaymentProcess(
      {
        method: 'upi',
        vpa: `${upiId.value}@${selectpicker.value}`
      },
      this
    );
  }
  ...
  render() {
    ...
    const banks = {'0': 'Select Bank', okhdfcbank: 'okhdfcbank', okicici: 'okicici', oksbi: 'oksbi', okaxis: 'okaxis'};
          ...
          <div className="head-other-mathod">
            ...
            <div className="block-bank-account-detail">
              <div className="block-content-smple">
                  <label className="title"><img width="25" src="https://cdn.razorpay.com/app/googlepay.svg" alt="Google Pay" /> Google Pay</label>
                  {
                    selectedOption == code && !disableOptions
                    &&
                    <div className="option-netbanking gpay-block">
                        <div className="dropdown">
                           <input ref="upiId" placeholder="Enter UPI ID" type="text" />
                           <span> @ </span>
                           <Dropdown ref="bank" options={banks} name="bank" />
